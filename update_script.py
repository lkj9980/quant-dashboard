...
replacement_str = '<script src="https://cdn.jsdelivr.5net/npm/chart.js"></script>' # 앗, 오타 방지용으로 수정!
...
if not os.path.exists(history_dir):
    ...
    for filename in os.listdir(history_dir):
        if filename.endswith(".html"):
            ...
            if '<script src="../Chart2.js">' in content or '<script src="../chart.js">' in content:
                ...
                updated_content = updated_content.replace('<script src="../Chart2.js"></script>', cdn_script)
                updated_content = updated_content.replace('<script src="../chart.js"></script>', cdn_script)
